...
export function useSessionExport(manifest: any) {
	...
	return { csvDownloading, annotationsDownloading, annotatedPdfDownloading, csvExportedRef, pdfExportedRef, convertToCSV, convertToCSVWithAnnotations, convertToPDF, convertToAnnotatedPDF, convertToRangePDF }
}
