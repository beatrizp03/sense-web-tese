...
const Page = () => {
	...
	}, [hydrated, sessionFolder, manifest, analysisResult, signalKinds, signalAxes, activeTab, status, showProgressPanel, outlierRemovalEnabled, edaMethodSelection, analysisStartTime])
	...
	}, [appliedSignalAxes, appliedSignalKinds, sessionFolder, outlierRemovalEnabled, edaMethodSelection])
								...
								<div className="space-y-3">
									{channels.length > 0 ? (
										channels.map(channel => {
											...
											return (
												<div key={channel} className="flex flex-col gap-2 rounded-xl border border-background-accent bg-background-accent-light p-4 sm:flex-row sm:items-center sm:justify-between dark:bg-background-accent-dark">
													<div className="flex items-center justify-between gap-3">
														<div>
															...
															<div className="text-xs text-over-background-low-light dark:text-over-background-low-dark">Channel {channel}</div>
														</div>
														<select
															value={selectedValue}
															onChange={event => {
