...
export const AnalysisProgressPanel: React.FC<AnalysisProgressPanelProps> = ({
  ...
  if (progress.errorMessage) {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
        <div className="w-full max-w-md rounded-lg border border-error-accent bg-background-accent p-6 shadow-lg">
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
      <div className="w-full max-w-md rounded-lg border border-background-accent bg-background-accent p-6 shadow-lg">
        <h2 className="mb-4 text-lg font-semibold text-over-background-highest">Analysis in Progress</h2>

        <div className="mb-6 space-y-3">
          <div className="space-y-2">
            <div className="flex items-center justify-between text-sm">
              <span className="text-over-background-medium">Progress</span>
              <span className="font-medium text-over-background-highest">{progress.percentage}%</span>
            </div>
            <div className="h-2 w-full overflow-hidden rounded-full bg-primary/20 border border-primary/40">
              <div
          ...
          <div className="space-y-1 pt-2">
            <p className="flex items-center gap-2 text-xs uppercase tracking-wider text-over-background-low">
              <span
                aria-hidden="true"
            ...
            <div className="rounded-lg bg-background-accent-dark px-3 py-2 dark:bg-background-accent-light">
